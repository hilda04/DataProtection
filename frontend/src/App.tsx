...
export default function App() {
  ...
  const [apiResult, setApiResult] = useState<FrameworksResult | null>(null);
  ...
  return (
    <main className="shell">
      ...
      <section className="panel actions-panel">
        ...
        <button disabled={isBusy} className="secondary-button" onClick={() => void refreshSessionState()} type="button">
          Refresh status
        </button>
      </section>
